...
//! `bitflags`.
//!
//! # Ограничение на сегодня
//!
//! Одно соединение обслуживает один запрос за раз, поэтому вызовы к одному
//! серверу выстраиваются в очередь. Это свойство нижнего слоя, а не этого API:
//! методы уже принимают `&self`, так что появление мультиплексирования
//! публичную сигнатуру не изменит.
//!
//! # Колбеки
//!
//! ```no_run
